    ...
    children: [
      ...
      },
      {
        ...
        content: [
          ...
          `<h6>Ранняя жизнь</h6>`,
          `Лонганус родился и рос при королевском дворе Дриствара вместе с наследным принцем Сралином. С малых лет его готовили как советника для будущего короля,
          но это не поменяло им завязать крепкую дружбу. Когда Сралин стал королем, он назначил Лонгануса своим советником и вместе они вели Дриствар к процветанию.`,
          ...
          Дриствар не примет его таким, какой он есть, он спрятал свои чувства и стал искать лазейки в законах и дристиянцких заветах.`,
          `<h6>Темный ритуал</h6>`,
          ...
          через него не протиснулось тело темной сучности. Хер Мемус проник в мир.`,
          `Не успел Лонганус осознать, что же он натворил, как пять рук схватили его, и Хер Мемус стал ебать его всеми пятнадцатью
          членами в жопу, рот и даже в нос, и продолжал он аж до рассвета. С каждым членом, который в нем побывал, Лонганус ощущал, что сильнее меняется. Он
          ...
          его насиловать, он поклялся ему служить. Он попросил у Хер Мемуса лишь одного - чтоб его возлюбленный Сралин получил такое же могущество, и чтоб
          именно Сралин был тем, кто станет направлять людей на путь Хер Мемуса.`,
          `<h6>Совращение короля</h6>`,
          `Благодаря близости Лонгануса и Сралина Хер Мемус получил возможность шептать из тени уже Сралину. Сам Лонганус получил приказ ожидать и быть
          ...
          довольствовались друг другом, и иногда Сралин даже подставлял своё очко товарищу. С темным влиянием Хер Мемуса появилась и жажда силы, и утолить её
          ...
          `Когда войска Дристоборода штурмовали столицу, Сралин бежал по тайным ходам Жепы, а Лонганус поджег дворец. Когда Дристобород добрался до дворца,
          ...
          `Хер Мемус сказал Лонганусу, что Сралин, переродившийся как Членин, начал распространять его влияние на западе континента. Когда Членин заявил о
          существовании Коково и начал войну против Дристиянцтва, Лонганус руководил дристварскими войсками. Он умело манипулировал полями боя, отдавая как
