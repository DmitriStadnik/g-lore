    ...
    children: [
      ...
      },
      {
        ...
        content: [
          ...
          `<h6>Дедушка Нигер</h6>`,
          `В древности, когда Нигермания только зарождалась, один из нигеров всосал в себя так много наркоты, что мгновенно умер. Последняя его мысль
      ...
      },
      {
        ...
        content: [
          ...
          Великого Рофла, но после становления верховной богиней Пиздраиля ее тщеславие стало расти.`,
          ...
          `Создала Бабку Бібку Бобку, чтоб та соблазнила Дристца, и у Аманды был повод уйти от него. Пошло не по плану,
          уходить пришлось по надуманному поводу. Бобка с тех пор прячется от неё в Великом Болоте.`,
          `Заявляла, что после расставания с Дристцом Хер Мемус Н'Кок пытался её соблазнить. Хоть ей это и льстило, она его отвергла
      ...
      },
      {
        ...
        content: [
          ...
          `Когда Дристоц совершил Великий Рофл, он взял в свой новый мир свих жену и дочь, но пренебрег своими друзьями. Обиженные, Хер Мемус Н'Кок и Вездессущ решили, 
          ...
          `В Дристваре регулярно проводятся инспекции всех врачей, так как обращенные врачи тайком предлагают пациентам уринотерапию вместо нормальных методов лечения.`,
        ]
      },
      {
        ...
        content: [
          ...
          `<h6>Появление в мире</h6>`,
          `Когда Дристоц совершил Великий Рофл, он взял в свой новый мир свою жену и дочь, но пренебрег своими друзьями. Обиженные, Хер Мемус Н'Кок и Вездессущ решили, 
