    ...
    children: [
      ...
      },
      {
        ...
        content: [
          ...
          `<h6>Дедушка Нигер</h6>`,
          `В древности, когда Нигермания только зарождалась, один из нигеров всосал в себя так много наркоты, что погиб на месте. Последняя его мысль
          ...
          и назначил того нигера малым богом, смотрителем Нигермании. `,
          `Хитрожопый уебан, коварством и подлостью не уступающий Твердому и его ебаным сфинктрсам. Каждому ребенку-нигеру, который ведёт 
