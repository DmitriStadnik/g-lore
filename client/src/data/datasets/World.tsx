    ...
    children: [
      {
        ...
        isMainArticle: true,
        content: [
          `<img src="${map}" class="article-image" alt="Карта Аналлона, 37 ПГС" />`,
      ...
      },
      {
        ...
        content: [
          ...
          и У.Е.Бан когда-то являлись (или являются) одними из ключевых членов ХРОШНИ, однако достоверных подтверждений этому не найдено.`,
          ...
          `<h6>МУЛЬТИОЛЕГ</h6>`,
          `Вскоре после вознесения Легендарных Основателей разрозненная ХРОШНЯ, потерявшая руководителей, попыталась повторить подвиг Основателей,
          создав из трех неизвестных сущностей Триединого МУЛЬТИОЛЕГА. Данная сущность была настолько могущественной, что несла опасность для ХРОШНИ и всего Аналлона,
          потому МУЛЬТИОЛЕГ был разделен на ОЛЕГА, Кошьку Олега и СТАСА. Объединение этих троих в единую сущность с тех пор под строжайшим запретом.`,
          `<h6>Структура ХРОШНИ</h6>`,
          ...
          Вызван ли такой гнев тем, что сам У.Е.Бан прекрасно осведомлен о том, кто такой ОЛЕГ, и негодует по поводу отсталости своих коллег? Кто знает...`,
          `Чтоб облегчить тяжкую ношу власти, которая ложится на плечи ОЛЕГА, для него всегда выбирается верный соратник и компаньон - Кошька ОЛЕГА. Кошька сопровождает
          ОЛЕГА, поддерживая его во всем. Для каждого ОЛЕГА выбирается своя Кошька, и для этой должности практически нет требований: Кошькой может стать даже
          искусственная форма жизни, если она обладает хотя бы минимальным интеллектом.`,
          `Темной стороной ХРОШНИ - ГРОБШНЕЙ управляет таинственный СТАС. Далеко не все члены ХРОШНИ знают про существование ГРОБШНИ, потому и не все знают про существование
          СТАСА и его деятельность.`,
          `Инспектор Ебаных Обид помогает ОЛЕГУ проводить инспекции Ебаных Обид, которые члены ХРОШНИ вписывают в Книгу Ебаных Обид.`,
        ]
      },
      {
      ...
      },
      {
        ...
        content: [
          ...
          `<h6>Дристочка</h6>`,
          `Птица, которая летает на двойной реактивной струе дриста. Послепивная дристочка - популярная в Дристваре закуска к пиву из вяленного мяса дристочек.`,
          `<h6>Птица ХуйуХ</h6>`,
          ...
          `<h6>Осел-калоед</h6>`,
          `Редкий вид осла, который питается только калоритом и говном. Невероятно тупой, но очень выносливый.`,
          `<h6>Поджопный жмыхлик</h6>`,
          `Отвратительные твари, которых порождают (высирают) исчадия ануса. Похожи на многоножек. Засверливаются в анусы незараженным и заражают их анальной цингой.`,
          `<h6>Очкошка</h6>`,
          `Редкий вид дристварской степной кошки. Кошка с одним глазом, которая, чувствуя угрозу, может из глаза или очка выдать мощную струю говна в глаза обидчика.`,
        ]
      },
      {
        ...
        content: [
          ...
          Когда Дристоц узнал об этом, он наградил смельчаков и поставил их во главе основанной ради охоты на Нассонов <a href="/${transliterateRus('Мир')}/${transliterateRus('Насральская Инквизиция')}">Насральской Инквизиции</a>.`,
      ...
      {
        title: 'Насральская Инквизиция',
        content: [
          `Насральская Инквизиция - древний орден, противостоящий Вездессущу и его последователям.`,
          `<h6>История</h6>`,
          `В древности, когда еще Дристоц ходил по миру среди людей, Вездессущ нашел первых последователей в дристварском городе Насральск. Они пытались сначала хитростями,
          а потом и силой захватить город, обратив всех жителей в веру в Вездессуща. Небольшая группа отважных храбрецов дала им бой, выгнав их из города ссаными тряпками.`,
          `Когда Дристоц узнал об этом, он снизошел в Насральск, лично очистив его от порчи. Он даровал героям-защитникам Насральска священную миссию - бороться с темным влиянием
          Вездессуща на Аналлон, и нарек их Насральской Инквизицией. Благодарные жители построили для героев Инквизиториум, который и по сей день является главной базой Инквизиции.`,
          `<h6>Структура Ордена</h6>`,
          `Во главе Инквизиции стоит Магистр. Магистра выбирают среди самых доблестных членов организации и он занимает свою должность до смерти. В 37 ПГС Магистром является
          Кал Фарадей-Без-Задних-Дверей.`,
          `Во главе всех расследований и боевых операций стоят Следователи. Обученные расследованиям, допросам, пыткам и проведению скрытных операций, они без колебаний
          судят всех, кто причастен к деятельности Нассонов.`,
          `Обладающие даром лидерства и расположения к себе людей выступают в роли Глашатаев Инквизиции. Они занимаются распространением информации
           о Нассонах среди народа и участвуют в переговорах с союзниками Инквизиции.`,
          `Рожденные с даром каломантии в Инквизиции становятся Экзорцистами. Кроме боевой каломантии, они обучаются обнаружению влияния Темных Богов на мир и людей, 
          и проведению ритуалов очищения и изгнания зла.`,
          `Неофиты, обладающие не только крепким разумом, но и крепким телом, могут стать Зилотами - бесстрашными воинами, наводящими страх на всех, 
          кто поддался пагубному влиянию Вездессуща. Облаченные в тяжелые доспехи и вооруженные специально выкованным для них оружием, они сражаются со 
          злом, не заботясь о собственной жизни.`,
          `<h6>Деятельность</h6>`,
          `Насральская Инквизиция обладает неограниченными полномочиями во всех вопросах, касающихся противостояния последователям Вездессуща. При получении сведений о 
          деятельности культистов, инквизитор обязан проверить их правдивость, обнаружить виновных, допросить их и вынести приговор.`,
          `В ряды инквизиции принимают всех желающих. Даже если неофит не обладает особыми навыками, ему найдется место в одном из Инквизиториумов 
          в качестве учителя, деловода, повара и прочего обслуживающего персонала.`,
          `К 37 году ПГС Насральская Инквизиция открыла Инквизиториумы по всему континенту, заручившись поддержкой властей других стран. Инквизиториумам разрешено
          принимать на службу не только дристиянцев. Специально для похуистов и следующих Пути Семи Залуп местными Инквизиториумами разработаны способы противостояния
          Вездессущу и его последователям.`,
        ]
      },
