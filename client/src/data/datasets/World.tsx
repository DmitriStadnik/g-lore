    ...
    children: [
      ...
      },
      {
        ...
        content: [
          ...
          `В научных кругах ходило мнение, что Е. Б. Анат сам когда-то являлся (или является) 
          одним из ключевых членов ХРОШНИ, однако достоверных подтверждений этому не найдено.`,
