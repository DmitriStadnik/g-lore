    ...
    children: [
      {
        ...
        isMainArticle: true,
        content: [
          `Уранус - имя, данное Дристцом миру, который был создан в результате 
      ...
      },
      {
        ...
        content: [
          ...
          Дристоц не упустил открывшиеся перед ним возможности и перспективы и с головой погрузился в работу над этим неведомым миром, который он назвал <a href="/${transliterateRus('Мир')}/${transliterateRus('Уранус')}">Уранус</a>.`,
      ...
      },
      {
        ...
        content: [
          ...
          `<a href="/${transliterateRus('Дриствар')}/${transliterateRus('Король Дристобород')}">Дристобород</a> не мог позволить себе дальше 
      ...
      },
      {
        ...
        content: [
          ...
          жрицам культа Аманды доступна базовая каломантия.`,
          ...
          но так как их магия чужда этому миру, калорит этому сопротивляется.`,
          ...
          `<a href="/${transliterateRus('Джене-Рико')}/${transliterateRus('Дженериковые Царства')}">Дженерики</a>, которым недоступна каломантия, 
