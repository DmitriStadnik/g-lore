    ...
    children: [
      {
        ...
        isMainArticle: true,
        content: [
          `Уранус - имя, данное Дристцом миру, который он создал.`,
          `<h6>Строение</h6>`,
          `Уранус - плоский мир, который находится в карманном измерении в форме сферы. Вокруг диска вращаются солнце и луна. Присутствуют климатические зоны.
          Земля наполнена ископаемыми говнами.`,
          ...
          островов. Океан на границах диска стекает на Темную Сторону.`,
          `<h6>Темная сторона Урануса</h6>`,
          `Про Темную Сторону Урануса практически ничего не известно. Ходят теории, что там обитают потусторонние сучности. Никто до сих пор даже не пытался
      ...
      },
      {
        ...
        content: [
          ...
          Дристоц не упустил открывшиеся перед ним возможности и перспективы и с головой погрузился в работу над этим неведомым миром, который он назвал Уранус.`,
      ...
      },
      {
        ...
        content: [
          ...
          частого использования жительницами Пиздраиля в своих грязных женских целях.`,
          `<h6>Кунь</h6>`,
