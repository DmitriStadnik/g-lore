    ...
    children: [
      {
        ...
        isMainArticle: true,
        content: [
          `Анналлон - имя, данное Дристцом миру, который был создан в результате 
            <a href="/${transliterateRus('Мир')}/${transliterateRus('Великий Рофл')}">Великого Рофла</a>.`,
          `<h6>Строение</h6>`,
          `Анналлон - плоский мир, который находится в карманном измерении в форме сферы. Вокруг диска вращаются солнце и луна. Присутствуют климатические зоны.
          ...
          `<h6>Темная сторона Анналлона</h6>`,
          `Про Темную Сторону Анналлона практически ничего не известно. Ходят теории, что там обитают потусторонние сучности. Никто до сих пор даже не пытался
      ...
      },
      {
        ...
        content: [
          ...
          Дристоц не упустил открывшиеся перед ним возможности и перспективы и с головой погрузился в работу над этим неведомым миром, который он назвал <a href="/${transliterateRus('Мир')}/${transliterateRus('Анналлон')}">Анналлон</a>.`,
