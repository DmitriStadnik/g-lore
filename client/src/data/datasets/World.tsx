    ...
    children: [
      ...
      },
      {
        ...
        content: [
          ...
          Дристоц не упустил открывшиеся перед ним возможности и перспективы и с головой погрузился в работу над этим неведомым миром, который он назвал <a href="/${transliterateRus('Мир')}/${transliterateRus('Анналлон')}">Уранус</a>.`,
